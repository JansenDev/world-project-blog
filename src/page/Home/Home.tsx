...
function Home() {
  return (
    <div className="h-[calc(100vh-211px)] sm:h-[calc(100vh-195px)]">
      <div className="h-[calc(40vh-76px)] sm:h-[calc(60vh-76px)] bg-[url('@assets/images/background.webp')] bg-no-repeat bg-cover bg-top relative rounded-md shadow-sm">
        ...
        px-4 py-2 rounded-r-lg shadow-md sm:w-max font-elsie bottom-0 right-0 left-0 text-center">Bienvenidos</div>
      </div>
