...
function Header() {
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-700 dark:border-gray-700 py-3 dark:rounded-md rounded-sm w-5/6 mx-auto">
      <section className="flex flex-wrap justify-between items-center mx-auto">
        <Link to="/" className="flex items-center">
          ...
          <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white font-elsie">World Project</span>
        </Link>
        ...
        <div className=" hidden w-full md:block md:w-auto" id="mobile-menu">
          <ul className=" uppercase flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
            ...
            <li>
              <Link to="/" className="font-bold hover:text-blue-700 block py-2 pr-4 pl-3 text-white bg-gray-700 rounded md:bg-transparent md:text-gray-700 md:p-0 md:dark:text-white dark:bg-blue-600 md:dark:bg-transparent " aria-current="page">Novelas activas</Link>
            </li>
            <li>
